The file <a href= "./Exhaustive Search.ipynb">Exhaustive Search.ipynb</a> uses Levenshtein edit-distance between two city name of the same country, this is an exhaustive search approach.<br>
